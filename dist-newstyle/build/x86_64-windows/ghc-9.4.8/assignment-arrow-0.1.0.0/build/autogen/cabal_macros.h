...
/* package assignment-arrow-0.1.0.0 */
#ifndef VERSION_assignment_arrow
#define VERSION_assignment_arrow "0.1.0.0"
#endif /* VERSION_assignment_arrow */
#ifndef MIN_VERSION_assignment_arrow
#define MIN_VERSION_assignment_arrow(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_assignment_arrow */
...
#define CURRENT_PACKAGE_KEY "assignment-arrow-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "assignment-arrow-0.1.0.0-inplace"
